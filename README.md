Простейшее spring-boot приложение, включайшие в себя и настроеный минимальный базовый функционал. Реализует одно REST-API /ping.
...
* натроены и реализованы тестирование JUnit
