...
import org.heartsales.model.rest.ErrorModel;
...
public interface IntegrationApi {
    ...
    default ResponseEntity<PongModel> ping() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{  \"result\" : \"result\"}", PongModel.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
